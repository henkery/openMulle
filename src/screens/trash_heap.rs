...
//     deploy_clickables::<OnTrashYellowScreen, &[MulleClickable]>(
//         commands,
//         &[
...
//             ),
//             mulle_clickable_from_name(
//                 vec![ClickAction::RoomstateTransition {
...
//     deploy_clickables::<OnTrashRedScreen, &[MulleClickable]>(
//         commands,
//         &[
//             mulle_clickable_from_name(
//                 vec![ClickAction::GamestateTransition {
...
//     deploy_clickables::<OnTrashPurpleScreen, &[MulleClickable]>(
//         commands,
//         &[
//             mulle_clickable_from_name(
//                 vec![ClickAction::GamestateTransition {
...
//     deploy_clickables::<OnTrashBlueScreen, &[MulleClickable]>(
//         commands,
//         &[
//             mulle_clickable_from_name(
//                 vec![ClickAction::GamestateTransition {
...
//     deploy_clickables::<OnTrashTurquiseScreen, &[MulleClickable]>(
//         commands,
//         &[
//             mulle_clickable_from_name(
//                 vec![ClickAction::GamestateTransition {
...
//     deploy_clickables::<OnTrashGreenScreen, &[MulleClickable]>(
//         commands,
//         &[
//             mulle_clickable_from_name(
//                 vec![ClickAction::GamestateTransition {
